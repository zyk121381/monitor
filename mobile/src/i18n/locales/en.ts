export default {
  ...
  auth: {
    ...
    logoutDescription:
      "Log out of your current account and return to the login screen",
  },
  ...
  monitors: {
    ...
    checkNowSuccessMessage:
      "The check was initiated successfully, please refresh to see the result",
  ...
  notifications: {
    ...
    globalSettingsConfig: {
      ...
      globalDescription:
        "Configure system-level global notification settings that will be applied as defaults to all monitors and agents.",
      globalInfo:
        "Configure global default notification settings on this page, including basic settings for monitor and agent alerts. You can configure notifications for specific monitors or agents on their respective settings pages.",
      enabled: "Enable Notifications",
    },
    monitors: {
      description:
        "Configure global default alert notification settings for all API monitors.",
      enabledDescription:
        "When enabled, you will receive notifications for all monitors.",
      onDown: "Notify On Down",
      onDownDescription:
        "Send a notification when a monitor detects a failure.",
      onRecovery: "Notify On Recovery",
      onRecoveryDescription:
        "Send a notification when a monitor recovers from a failure.",
    },
    agents: {
      description:
        "Configure global default alert notification settings for all agents.",
      enabledDescription:
        "When enabled, you will receive notifications for all agents.",
      onOffline: "Notify On Offline",
      onOfflineDescription: "Send a notification when an agent goes offline.",
      onRecovery: "Notify On Recovery",
      onRecoveryDescription:
        "Send a notification when an agent recovers from offline status.",
      onCpuThreshold: "CPU Threshold Alert",
      onCpuThresholdDescription:
        "Send a notification when CPU usage exceeds the threshold.",
      cpuThreshold: "CPU Threshold",
      cpuThresholdDescription:
        "Enter a value between 1 and 100. An alert will be triggered when CPU usage exceeds this threshold.",
      onMemoryThreshold: "Memory Threshold Alert",
      onMemoryThresholdDescription:
        "Send a notification when memory usage exceeds the threshold.",
      memoryThreshold: "Memory Threshold",
      memoryThresholdDescription:
        "Enter a value between 1 and 100. An alert will be triggered when memory usage exceeds this threshold.",
      onDiskThreshold: "Disk Threshold Alert",
      onDiskThresholdDescription:
        "Send a notification when disk usage exceeds the threshold.",
      diskThreshold: "Disk Threshold",
      diskThresholdDescription:
        "Enter a value between 1 and 100. An alert will be triggered when disk usage exceeds this threshold.",
    },
    specificSettings: {
      title: "Specific Monitor Notification Settings",
      description:
        "Configure separate notification settings for each specific monitor.",
      channels: "Notification Channels",
    ...
    channelSettings: {
      ...
      description:
        "Configure different notification channels to receive alerts from monitors and systems.",
      add: "Add Channel",
      edit: "Edit Channel",
    ...
    responseTimeThresholdDescription:
      "An alert will be triggered when response time exceeds this threshold (milliseconds)",
    consecutiveFailures: "Consecutive Failures",
    consecutiveFailuresDescription:
      "An alert will be triggered when consecutive failures reach the threshold",
  ...
  settings: {
    ...
    apiUrlSaved:
      "API address saved. Please restart the app for changes to take effect.",
