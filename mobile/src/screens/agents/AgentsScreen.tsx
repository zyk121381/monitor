    ...
    >
      ...
      <View style={styles.systemInfo}>
        ...
        <View style={styles.infoItem}>
          ...
          <Text style={styles.infoText}>
            {t("agents.version", "版本")}{" "}
            {item.version || t("common.unknown", "未知")}
          </Text>
        </View>
      </View>
      ...
      {item.status === "active" && (
        <View style={styles.resourcesContainer}>
          ...
          <View style={styles.resourceItem}>
            ...
            <Text style={styles.resourceValue}>
              {item.memory_used && item.memory_total
                ? ((item.memory_used / item.memory_total) * 100).toFixed(1)
                : 0}
              %
            </Text>
          </View>
          ...
          <View style={styles.resourceItem}>
                  ...
                  styles.progressBar,
                  {
                    width: `${
                      item.disk_used && item.disk_total
                        ? (item.disk_used / item.disk_total) * 100
                        : 0
                    }%`,
                    backgroundColor: getResourceColor(
                      item.disk_used && item.disk_total
            ...
            <Text style={styles.resourceValue}>
              {item.disk_used && item.disk_total
                ? ((item.disk_used / item.disk_total) * 100).toFixed(1)
                : 0}
              %
            </Text>
          </View>
      ...
      <View style={styles.container}>
        <View style={styles.filterContainer}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            ...
            >
              <View
                style={[styles.statusIndicator, { backgroundColor: "#888" }]}
              />
              <Text
                style={[
                  styles.filterText,
