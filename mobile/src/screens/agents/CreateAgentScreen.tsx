    ...
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>
          {t("agents.generatingToken", "正在生成注册Token...")}
        </Text>
      </View>
    );
  }
  ...
  return (
    ...
    >
      <View style={styles.formContainer}>
        ...
        <View style={styles.section}>
          <Text style={styles.label}>
            {t("agents.registrationToken", "注册令牌")}
          </Text>
          <View style={styles.codeBlock}>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>
            {t("agents.installGuide", "安装指南")}
          </Text>

          <Text style={styles.label}>
            {t("agents.selectPlatform", "1. 选择操作系统")}
          </Text>
          <View style={styles.optionsRow}>
            <TouchableOpacity
              style={[
                styles.optionButton,
                selectedPlatform === "linux" && styles.selectedOption,
              ]}
            ...
            >
              <Text
                style={[
                  styles.optionText,
                  selectedPlatform === "linux" && styles.selectedOptionText,
                ]}
              >
                Linux
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.optionButton,
                selectedPlatform === "darwin" && styles.selectedOption,
              ]}
            ...
            >
              <Text
                style={[
                  styles.optionText,
                  selectedPlatform === "darwin" && styles.selectedOptionText,
                ]}
              >
                macOS
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.optionButton,
                selectedPlatform === "windows" && styles.selectedOption,
              ]}
            ...
            >
              <Text
                style={[
                  styles.optionText,
                  selectedPlatform === "windows" && styles.selectedOptionText,
                ]}
              >
                Windows
              </Text>
          ...
          {/* 选择架构部分 */}
          <Text style={styles.label}>
            {t("agents.selectArch", "2. 选择系统架构")}
          </Text>
          <View style={styles.optionsRow}>
            <TouchableOpacity
              style={[
                styles.optionButton,
                selectedArch === "amd64" && styles.selectedOption,
              ]}
            ...
            >
              <Text
                style={[
                  styles.optionText,
                  selectedArch === "amd64" && styles.selectedOptionText,
                ]}
              >
            ...
            <TouchableOpacity
              style={[
                styles.optionButton,
                selectedArch === "arm64" && styles.selectedOption,
              ]}
            ...
            >
              <Text
                style={[
                  styles.optionText,
                  selectedArch === "arm64" && styles.selectedOptionText,
                ]}
              >
                {selectedPlatform === "darwin"
                  ? "ARM64 (Apple Silicon)"
        ...
        {selectedPlatform === "windows" ? (
          <View style={styles.section}>
            <Text style={styles.label}>
              {t("agents.downloadInstaller", "3. 下载安装文件")}
            </Text>
            <TouchableOpacity
        ...
        <View style={styles.buttonRow}>
          ...
          >
            <Text style={styles.secondaryButtonText}>
              {t("agents.returnToList", "返回客户端列表")}
            </Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.resetButton} onPress={generateToken}>
            <Text style={styles.resetButtonText}>
              {t("agents.generateNewToken", "生成新Token")}
            </Text>
          </TouchableOpacity>
        </View>
      </View>
