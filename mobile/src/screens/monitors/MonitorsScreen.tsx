...
const MonitorsScreen: React.FC = () => {
  ...
  const renderMonitorItem = ({ item }: { item: Monitor }) => (
    <TouchableOpacity
      ...
      onPress={() =>
        navigation.navigate("MonitorDetail", { monitorId: item.id })
      }
      activeOpacity={0.7}
    >
      <View style={styles.monitorContent}>
        ...
        <View style={styles.statsContainer}>
          ...
          <View style={styles.statItem}>
            ...
            <Text style={styles.statLabel}>
              {t("monitors.response_time", "响应时间(ms)")}
            </Text>
          </View>
        ...
        <View style={styles.filterContainer}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            ...
            <TouchableOpacity
              style={[
                styles.filterButton,
                filter === "up" && styles.filterButtonActive,
              ]}
              onPress={() => handleFilterChange("up")}
            >
              <View
                style={[styles.statusIndicator, { backgroundColor: "#30c85e" }]}
              />
              <Text
                style={[
                  styles.filterText,
                  filter === "up" && styles.filterTextActive,
                ]}
              >
            ...
            <TouchableOpacity
              style={[
                styles.filterButton,
                filter === "down" && styles.filterButtonActive,
              ]}
              onPress={() => handleFilterChange("down")}
            >
              <View
                style={[styles.statusIndicator, { backgroundColor: "#f76363" }]}
              />
              <Text
                style={[
                  styles.filterText,
                  filter === "down" && styles.filterTextActive,
                ]}
              >
