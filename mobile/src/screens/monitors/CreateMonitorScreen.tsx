...
const CreateMonitorScreen: React.FC = () => {
  ...
  const statusCodeOptions: StatusCodeOption[] = [
    ...
    {
      label: `201 - ${t("monitors.statusCodes.created", "Created")}`,
      value: "201",
    },
    {
      label: `204 - ${t("monitors.statusCodes.noContent", "No Content")}`,
      value: "204",
    },
    {
      label: `2xx - ${t("monitors.statusCodes.successful", "Successful")}`,
      value: "2xx",
    },
    {
      label: `301 - ${t(
        "monitors.statusCodes.movedPermanently",
        "Moved Permanently"
      )}`,
      value: "301",
    },
    {
      label: `302 - ${t("monitors.statusCodes.found", "Found")}`,
      value: "302",
    },
    {
      label: `3xx - ${t("monitors.statusCodes.redirection", "Redirection")}`,
      value: "3xx",
    },
    {
      label: `400 - ${t("monitors.statusCodes.badRequest", "Bad Request")}`,
      value: "400",
    },
    {
      label: `401 - ${t("monitors.statusCodes.unauthorized", "Unauthorized")}`,
      value: "401",
    },
    {
      label: `403 - ${t("monitors.statusCodes.forbidden", "Forbidden")}`,
      value: "403",
    },
    {
      label: `404 - ${t("monitors.statusCodes.notFound", "Not Found")}`,
      value: "404",
    },
    {
      label: `4xx - ${t("monitors.statusCodes.clientError", "Client Error")}`,
      value: "4xx",
    },
    {
      label: `500 - ${t(
        "monitors.statusCodes.serverError",
        "Internal Server Error"
      )}`,
      value: "500",
    },
    {
      label: `502 - ${t("monitors.statusCodes.badGateway", "Bad Gateway")}`,
      value: "502",
    },
    {
      label: `503 - ${t(
        "monitors.statusCodes.serviceUnavailable",
        "Service Unavailable"
      )}`,
      value: "503",
    },
    {
      label: `504 - ${t(
        "monitors.statusCodes.gatewayTimeout",
        "Gateway Timeout"
      )}`,
      value: "504",
    },
    {
      label: `5xx - ${t("monitors.statusCodes.serverErrors", "Server Error")}`,
      value: "5xx",
    },
  ];
  ...
  const getSelectedStatusCodeLabel = () => {
    const selected = statusCodeOptions.find(
      (option) => option.value === expectedStatus
    );
  ...
  return (
    ...
    >
      <View style={styles.formContainer}>
        ...
        <Text style={styles.label}>
          {t("monitors.expectedStatus", "预期状态码")} *
        </Text>
        <TouchableOpacity
          ...
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>
                {t("monitors.selectStatusCode", "选择状态码")}
              </Text>
              <TouchableOpacity
