...
const MonitorsNavigator = () => {
  ...
  return (
    ...
    >
      <MonitorsStack.Screen name="MonitorsList" component={MonitorsScreen} />
...
const AgentsNavigator = () => {
  ...
  return (
    ...
    >
      ...
      <AgentsStack.Screen name="AgentDetail" component={AgentDetailScreen} />
      <AgentsStack.Screen name="CreateAgent" component={CreateAgentScreen} />
    </AgentsStack.Navigator>
  );
};
    ...
    >
      ...
      <MainTab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size, focused }) => (
            <TabIcon
              name={"pulse" as keyof typeof Ionicons.glyphMap}
              color={color}
              size={size}
              focused={focused}
            />
      ...
      <MainTab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size, focused }) => (
            <TabIcon
              name={"hardware-chip" as keyof typeof Ionicons.glyphMap}
              color={color}
              size={size}
              focused={focused}
            />
...
const AppNavigator = ({
  ...
  initialApiConfigured: boolean | null;
}) => {
  const colorScheme = useColorScheme();
  const [apiUrlSettingsVisible, setApiUrlSettingsVisible] = React.useState(
    !initialApiConfigured
  );
