 ...
 */
const ChannelSelector = ({ channels, selectedChannelIds, onChange, placeholder }: ChannelSelectorProps) => {
  ...
  const getSelectedText = () => {
    ...
    if (selectedChannelIds.length === 1) {
      ...
      return channel ? channel.name : placeholder || t('notifications.channels.selectChannels');
    }
    
    return `${selectedChannelIds.length} ${t('notifications.channels.selected')}`;
  };
