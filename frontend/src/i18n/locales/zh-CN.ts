const zhCN = {
  translation: {
    ...
    'notifications.channels.type.email': '电子邮件',
    ...
    'notifications.channels.errors.smtpServerRequired': 'SMTP服务器地址为必填项',
    'notifications.channels.errors.smtpPortRequired': 'SMTP端口为必填项',
    'notifications.channels.errors.invalidSmtpPort': 'SMTP端口必须是数字',
    'notifications.channels.errors.smtpUsernameRequired': 'SMTP用户名为必填项',
    'notifications.channels.errors.smtpPasswordRequired': 'SMTP密码为必填项',
    'notifications.channels.errors.senderEmailRequired': '发件人邮箱为必填项',
    'notifications.channels.errors.invalidEmail': '邮箱格式无效',
    'notifications.channels.errors.recipientsRequired': '收件人邮箱为必填项',
    'notifications.channels.invalidId': '无效的渠道ID',
    'notifications.channels.smtpServer': 'SMTP服务器地址',
    'notifications.channels.smtpPort': 'SMTP端口',
    'notifications.channels.smtpUsername': 'SMTP用户名',
    'notifications.channels.smtpPassword': 'SMTP密码',
    'notifications.channels.senderEmail': '发件人邮箱',
    'notifications.channels.recipients': '收件人邮箱',
    'notifications.channels.recipientsHelp': '多个收件人请用逗号分隔',
    'notifications.channels.useSSL': '使用SSL/TLS加密',
    'notifications.channels.testing': '测试中...',
    'notifications.channels.test': '测试',
    'notifications.channels.testSuccess': '测试成功，通知已发送',
    'notifications.channels.testFailed': '测试失败，请检查配置',
