const zhCN = {
  translation: {
    ...
    "home.getStarted": "查看状态",
    "home.learnMore": "了解更多",
    "home.features.title": "功能特点",
    "home.features.monitoring": "实时监控",
    "home.features.monitoring.desc": "对本站公共服务和部分服务器进行实时监控",
    "home.features.alerts": "告警通知",
    "home.features.alerts.desc": "当监控出现异常时，及时通知站长进行维护",
    ...
    "agent.add.serverAddressPlaceholder":
      "请输入服务端地址，例如：https://xugou.example.com",
    ...
    "notifications.channels.fromHint":
      '支持格式: "您的名称 <email@example.com>" 或 "email@example.com"',
